...
export default function UnverifiedInvestorDealsPage() {
  // Placeholder filters
  const filterOptions = [
    "All Deals",
    "FinTech",
  ...
  const deals = [
    ...
    },
    {
      ...
      status: "Open",
      summary:
        "Revolutionary educational technology platform making quality education accessible through AI-driven personalized learning.",
      ticketSize: "₹10L - ₹1Cr",
      irr: "35-40%",
      ndaStatus: true,
    },
    {
      ...
      status: "Closing Soon",
      summary:
        "Next-generation logistics optimization platform using AI to streamline supply chain operations and reduce costs.",
      ticketSize: "₹75L - ₹7Cr",
      irr: "22-28%",
      ndaStatus: false,
    },
    {
      ...
      status: "Open",
      summary:
        "Advanced cybersecurity solutions provider protecting enterprises from emerging digital threats with AI-powered defense systems.",
      ticketSize: "₹50L - ₹5Cr",
      irr: "28-32%",
      ndaStatus: true,
    },
  ...
  const handleVerify = (id) => {
    ...
    // router.push('/unverified-investor/verification');
  };
  const handleView = (slug) => {
    router.push(`/unverified-investor/deals/${slug}`);
  };
