...
export default function ModalMessage({ show, onClose, type = "success", message, onConfirm, confirmText = "Confirm", showCancel = false }) {
  if (!show) return null;
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-sm p-6 relative text-center">
        ...
        <div className="text-lg font-semibold mb-2 text-primarycolor">
          {type === "success" ? "Success" : type === "confirm" ? "Confirm Delete" : "Error"}
        </div>
