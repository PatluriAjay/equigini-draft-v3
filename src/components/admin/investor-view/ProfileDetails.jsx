  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div>
        ...
        <div className="p-medium mb-1"><span className="text-secondary block">Mobile Number</span><span>{investor.phone}</span></div>
        <div className="p-medium mb-1"><span className="text-secondary block">PAN Number</span><span>{investor.pan_number}</span></div>
        <div className="p-medium mb-1"><span className="text-secondary block">Investment Range</span><span>₹{investor.ticket_range.min.toLocaleString('en-IN')} - ₹{investor.ticket_range.max.toLocaleString('en-IN')}</span></div>
        <div className="p-medium mb-1"><span className="text-secondary block">Preferred Sectors</span><span>{investor.preferred_sectors.join(', ')}</span></div>
      </div>
      {/* Address Info */}
      <div>
        <div className="heading-section mb-2">Address Information</div>
        <div className="p-medium mb-1"><span className="text-secondary block">Address Line 1</span><span>{investor.address_line1}</span></div>
        <div className="p-medium mb-1"><span className="text-secondary block">Address Line 2</span><span>{investor.address_line2}</span></div>
      ...
      <div>
        ...
        <div className="p-medium mb-1"><span className="text-secondary block">Registration Date</span><span>{investor.created_at}</span></div>
        ...
        <div className="p-medium mb-1"><span className="text-secondary block">Verification Status</span><span className="">Pending Review</span></div>
        <div className="p-medium mb-1"><span className="text-secondary block">NDA Status</span><span className="">Not Signed</span></div>
        <div className="p-medium mb-1"><span className="text-secondary block">Current Role</span><span>{investor.role.charAt(0).toUpperCase() + investor.role.slice(1)}</span></div>
