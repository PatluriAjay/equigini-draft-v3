...
export default function UnverifiedInvestorNavbar() {
  ...
  const navLinks = [
    { href: "/unverified-investor/dashboard", label: "Dashboard" },
    { href: "/unverified-investor/deals", label: "Deals" },
    { href: "/unverified-investor/saved-deals", label: "Watchlist" },
  ];
            ...
            <div className="relative" ref={menuRef}>
              ...
              {open && (
                <div className="absolute right-0 mt-2 w-44 bg-white rounded-xl shadow-lg py-2 z-50 border border-gray-100 animate-fade-in">
                  <Link
                    href="/unverified-investor/profile"
